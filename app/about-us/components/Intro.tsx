...
export default function Intro() {
  return (
    <div className="p-4 lg:p-8 font-mono bg-gray-50 grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-20 items-center py-2 lg:py-20">
      <div className="">
        <h2 className="font-bold text-3xl lg:text-5xl mb-5 lg:mb-15">
      ...
      <div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-2 items-center mt-6 text-xs lg:text-sm">
